...
if(isset($_GET['insert_cat'])){
    ...
    $ins_category = "insert into categories (cat_title) values('$cat_title');";
    $ins_category = mysqli_query($con, $ins_category);
    if($ins_category){
        header("location: ".$_SERVER['PHP_SELF']);
    }
    else {
        echo "Error Occured while inserting values into Category";
    }
}
?>
<!DOCTYPE html>
